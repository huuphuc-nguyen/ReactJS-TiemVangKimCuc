  ...
  return (
    <main 
      ...
      <div className='grid place-items-center h-full'>
        <div className='shadow-xl rounded-xl h-[25rem] w-[30rem] bg-white/60 backdrop-blur-md '>
          <form 
            className='w-full h-full flex flex-col items-start justify-center py-5 px-10' 
            onSubmit={handleSubmit(onSubmit)}>
            <h1 className='text-2xl font-bold text-primary ml-5 self-center'>Tiệm Vàng Kim Cúc</h1> 
